...
def render(data):
    ...
    body += text(22, 65, f"{data['repo_count']} public repos · {data['total_bytes']:,} bytes · default branches", "muted small")
    if not languages:
    ...
    body += text(22, height-18, "share of code bytes, not proficiency · includes owned forks", "muted tiny")
